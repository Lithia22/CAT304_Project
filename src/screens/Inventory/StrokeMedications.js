    ...
    >
      ...
      <View style={styles.statusContainer}>
        ...
        <TouchableOpacity 
          ...
          onPress={() => navigation.navigate('StrokeMedicationInfo', { id: medication.id })}
        >
...
const StrokeMedications = () => {
  ...
  const fetchMedications = async () => {
    try {
      setLoading(true);
      const response = await axios.get(buildApiUrl('/api/stroke-medications'));
  ...
  const confirmDelete = async () => {
    try {
      setLoading(true);
      await axios.delete(buildApiUrl(`/api/stroke-medications/${medicationToDelete}`));
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        <View style={styles.headerBar}>
          ...
          <Text style={styles.headerTitle}>Stroke</Text>
          <TouchableOpacity 
            style={styles.addButton}
            onPress={() => navigation.navigate('AddStrokeMedicationScreen')}
          >
      ...
      >
        {filteredMedications.map((medication) => (
          <MedicationCard
            ...
            onEdit={() => navigation.navigate('EditStrokeMedScreen', { 
...
export default StrokeMedications;