...
const AddKidneyMedicationScreen = ({ navigation }) => {
  ...
  const handleAddMedication = async () => {
    ...
    try {
      const response = await fetch(buildApiUrl('/api/kidney-disease-medicines'), {
          method: 'POST',
          headers: {
      ...
      if (responseData.success) {
        ...
        setTimeout(() => {
          ...
          navigation.navigate('KidneyDiseaseMedications', { 
...
export default AddKidneyMedicationScreen;