    ...
    >
      ...
      <View style={styles.statusContainer}>
        ...
        <TouchableOpacity 
          ...
          onPress={() => navigation.navigate('KidneyMedicationInfo', { id: medication.id })}
        >
...
const KidneyDiseaseMedications = () => {
  const navigation = useNavigation();
  ...
  const fetchMedications = async () => {
    try {
      setLoading(true);
      const response = await axios.get(buildApiUrl('/api/kidney-disease-medicines'));
  ...
  const confirmDelete = async () => {
    try {
      setLoading(true);
      await axios.delete(buildApiUrl(`/api/kidney-disease-medicines/${medicationToDelete}`));
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        <View style={styles.headerBar}>
          ...
          <Text style={styles.headerTitle}>Kidney Disease</Text>
          <TouchableOpacity 
            style={styles.addButton}
            onPress={() => navigation.navigate('AddKidneyMedicationScreen')}
          >
      ...
      >
        {filteredMedications.map((medication) => (
          <MedicationCard
            ...
            onEdit={() => navigation.navigate('EditKidneyMeddScreen', { 
...
export default KidneyDiseaseMedications;