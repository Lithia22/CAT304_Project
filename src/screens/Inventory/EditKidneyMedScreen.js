...
const EditKidneyMedScreen = ({ route, navigation }) => {
  ...
  const fetchMedicationDetails = async () => {
    try {
      const response = await fetch(buildApiUrl(`/api/kidney-disease-medicines/${medicationId}`));
...
export default EditKidneyMedScreen;