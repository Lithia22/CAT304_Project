...
const AddCancerMedicationScreen = ({ navigation }) => {
  ...
  const handleAddMedication = async () => {
    ...
    try {
      const response = await fetch(buildApiUrl('/api/cancer-medications'), {
          method: 'POST',
          headers: {
      ...
      if (responseData.success) {
        ...
        setTimeout(() => {
          ...
          navigation.navigate('CancerMedications', { 
...
export default AddCancerMedicationScreen;