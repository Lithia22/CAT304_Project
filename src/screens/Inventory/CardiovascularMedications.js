    ...
    >
      ...
      <View style={styles.statusContainer}>
        ...
        <TouchableOpacity 
          ...
          onPress={() => navigation.navigate('CardiovascularMedicationInfo', { id: medication.id })}
        >
...
const CardiovascularMedications = () => {
  const navigation = useNavigation();
  ...
  const fetchMedications = async () => {
    try {
      setLoading(true);
      const response = await axios.get(buildApiUrl('/api/cardiovascular-medications'));
  ...
  const confirmDelete = async () => {
    try {
      setLoading(true);
      await axios.delete(buildApiUrl(`/api/cardiovascular-medications/${medicationToDelete}`));
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        <View style={styles.headerBar}>
          ...
          <Text style={styles.headerTitle}>Cardiovascular</Text>
          <TouchableOpacity 
            style={styles.addButton}
            onPress={() => navigation.navigate('AddCardiovascularMedicationScreen')}
          >
      ...
      >
        {filteredMedications.map((medication) => (
          <MedicationCard
            ...
            onEdit={() => navigation.navigate('EditCardioMedScreen', { 
...
export default CardiovascularMedications;