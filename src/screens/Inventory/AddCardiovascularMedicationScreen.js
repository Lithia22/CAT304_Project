...
const AddCardiovascularMedicationScreen = ({ navigation }) => {
  ...
  const handleAddMedication = async () => {
    ...
    try {
      const response = await fetch(buildApiUrl('/api/cardiovascular-medications'), {
          method: 'POST',
          headers: {
      ...
      if (responseData.success) {
        ...
        setTimeout(() => {
          ...
          navigation.navigate('CardiovascularMedications', { 
...
export default AddCardiovascularMedicationScreen;