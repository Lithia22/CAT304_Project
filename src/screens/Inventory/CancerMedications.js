    ...
    >
      ...
      <View style={styles.statusContainer}>
        ...
        <TouchableOpacity 
          ...
          onPress={() => navigation.navigate('CancerMedicationInfo', { id: medication.id })}
        >
...
const CancerMedications = () => {
  ...
  const fetchMedications = async () => {
    try {
      setLoading(true);
      const response = await axios.get(buildApiUrl('/api/cancer-medications'));
  ...
  const confirmDelete = async () => {
    try {
      setLoading(true);
      await axios.delete(buildApiUrl(`/api/cancer-medications/${medicationToDelete}`));
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        <View style={styles.headerBar}>
          ...
          <Text style={styles.headerTitle}>Cancer</Text>
          <TouchableOpacity 
            style={styles.addButton}
            onPress={() => navigation.navigate('AddCancerMedicationScreen')}
          >
      ...
      >
        {filteredMedications.map((medication) => (
          <MedicationCard
            ...
            onEdit={() => navigation.navigate('EditCancerMedScreen', { 
...
export default CancerMedications;