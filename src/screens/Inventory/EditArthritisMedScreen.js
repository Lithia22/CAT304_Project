...
const EditArthritisMedScreen = ({ route, navigation }) => {
  ...
  const fetchMedicationDetails = async () => {
    try {
      const response = await fetch(buildApiUrl(`/api/arthritis-medications/${medicationId}`));
...
export default EditArthritisMedScreen;