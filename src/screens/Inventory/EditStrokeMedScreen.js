...
const EditStrokeMedScreen = ({ route, navigation }) => {
  ...
  const fetchMedicationDetails = async () => {
    try {
      const response = await fetch(buildApiUrl(`/api/stroke-medications/${medicationId}`));
...
export default EditStrokeMedScreen;