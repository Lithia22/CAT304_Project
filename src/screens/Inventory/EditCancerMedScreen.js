...
const EditCancerMedScreen = ({ route, navigation }) => {
  ...
  const fetchMedicationDetails = async () => {
    try {
      const response = await fetch(buildApiUrl(`/api/cancer-medications/${medicationId}`));
...
export default EditCancerMedScreen;