...
const AddArthritisMedicationScreen = ({ navigation }) => {
  ...
  const handleAddMedication = async () => {
    ...
    try {
      const response = await fetch(buildApiUrl('/api/arthritis-medications'), {
          method: 'POST',
          headers: {
      ...
      if (responseData.success) {
        ...
        setTimeout(() => {
          ...
          navigation.navigate('ArthritisMedications', { 
...
export default AddArthritisMedicationScreen;